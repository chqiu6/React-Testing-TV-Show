...
test("App fetches our data and renders it", async () => {
    //mock 
    mockFetchShow.mockResolvedValueOnce(episodes);
    const {getAllByText, getByText, findByText, getByTestId} = render(<App/>);
    ...
    expect(getByText(/season/i)).toBeInTheDocument();
}) 
